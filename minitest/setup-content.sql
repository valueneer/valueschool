...
(1, 'schulleitung', $$Bewährtes wird aufgeweicht$$, $$In deinem Kollegium gibt es eine Lehrkraft, die zunehmend von Vorgaben abweicht — kommt zu spät, gibt eigene Regeln raus, ignoriert Vereinbarungen. Das Kollegium wartet auf deine Reaktion. Was tust du?$$, $$Empathie$$, $$Ich frage vorsichtig nach, was eigentlich los ist.$$, 'beziehung', $$Zuverlässigkeit$$, $$Ich spreche die Person klar an und setze die Regeln durch.$$, 'sicherheit'),
...
('erfuellung-sicherheit',    $$Letzte Stichfrage: Du sollst eine Pflicht erfüllen, die dir aber innerlich nicht entspricht. Was wiegt für dich am Ende mehr?$$, $$Pflichtbewusstsein$$, $$Verlässlichkeit zählt — auch wenns mir nicht entspricht.$$, 'sicherheit', $$Authentizität$$, $$Wenns mir nicht entspricht, kann ich es nicht ehrlich tun.$$, 'erfuellung'),
...
('erfuellung-veraenderung',  $$Letzte Stichfrage: Du könntest aktiv die Welt um dich verändern oder erstmal in dich gehen und herausfinden, was wirklich zu dir passt. Was wiegt für dich am Ende mehr?$$, $$Selbstverwirklichung$$, $$Ich muss erst wissen, wer ich bin — dann gestalte ich.$$, 'erfuellung', $$Gestaltungswille$$, $$Ich packe an und gestalte aktiv. Selbsterkenntnis kommt im Tun.$$, 'veraenderung')
